...
### [ex00](https://github.com/odgigodji/CPP/tree/master/CPP00/ex00) : megaphon 
#### простая программа которая принимает на вход строку и печатает в стандартный вывод ее же, но в верхнем регистре.
